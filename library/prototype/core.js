// Core.js is the root custom file for new prototype Alpaca trading functions

// First connect to Alpaca
const API_KEY = 'PKZ44I2BO9AITQJ6WWHN';
const API_SECRET = '8POL/SsQwOW0QCqEbwIxdaXfncemazjlYTta0e1B';
const PAPER = true;
...
class LongShort {
  constructor ({ keyId, secretKey, paper = true, bucketPct = 0.25 }) {
    this.Alpaca = require('/library/alpaca-trade-api');
